            ...
            <Box style={{ display: 'flex', width: '80%', justifyContent: 'space-between' }}>
                ...
                <Box style={{ width: '85%'}}>
                    <Box style={{ display: 'flex', width: '85%', borderBottom: '2px solid black'}}>
                        <Box className={"hello_page_main_header_text"}>인사말</Box>
                    ...
                    <Box style={{ display: 'flex', flexDirection: 'column', width: '85%', margin: '20px 0px 0px 0px' }}>
                        ...
                        <Box className={"hello_page_main_text2"}>우리가 완성하고자 하는 시스템은 노인 커뮤니티 공간, 독거노인 주거공간, 공동홈 공간, 주간보호센터, 노인요양원을 지어 어르신들의 취미공간은 물론 </Box>
                        <Box className={"hello_page_main_text2"}>보호가 필요한 시점부터 돌아가실 때까지 마을에서 돌보고자 하는 것이 꿈입니다. 그러나 재정의 한계로 현재는 주간 보호센터와 커뮤니티 공간만을 준비했습니다.</Box>
                        <Box className={"hello_page_main_text2"}>커뮤니티 공간은 어르신들의 공동 홈 공간이나, 취미 공간으로 활용하고 있습니다. 또한 주간보호센터 공간에서는 보호가 필요한 어르신들을 모시고 즐거운 프로그램을 운영하게 됩니다.</Box>
                        <Box className={"hello_page_main_text2"}>우리마을 돌봄 센터는 돌봄 전문인력인 사회복지사, 간호조무사, 요양보호사, 프로그램 강사 등 모든 인원이 마을 분들로 구성되어 있어 어르신들이 편안함을 느끼실 겁니다.</Box>
