        ...
        <Box style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <Box style={{ display: 'flex', width: '75%', justifyContent: 'space-between' }}>
                <Box style={{ display: 'flex', width: '100%', borderBottom: '2px solid black' }}>
                    <Box className={ "main_header_text" }>시설안내</Box>
            ...
            <Box style={{ display: 'flex', width: '75%', justifyContent: 'space-between', margin: '20px 0px 0px 0px' }}>
                <Box style={{ width: '100%'}}>
                    ...
                    <Box className={ "place_page_main_row4" }>
                        <img className={ "place_page_main_row5" } src={place1}  alt="place1"/>
                    </Box>
                    <Box className={ "place_page_main_row3" }>
                        <Box>
                            어르신들의 치유를 위하여 조성한 텃밭
                        </Box>
                        <Box>
                            각종 허브와 국화꽃을 조성하여 스스로 키워보고 가굴 수 있는 텃밭으로 조성하였다.
                        </Box>
                    </Box>
                    ...
                    <Box className={ "place_page_main_row4" }>
                        <img className={ "place_page_main_row5" } src={place2}  alt="place2"/>
                    </Box>
                    <Box className={ "place_page_main_row3" }>
                        <Box>
                    ...
                    <Box className={ "place_page_main_row4" }>
                        <img className={ "place_page_main_row7" } src={place4}  alt="place4"/>
                    </Box>
                    <Box className={ "place_page_main_row3" }>
                        <Box>
                    ...
                    <Box className={ "place_page_main_row4" }>
                        <img className={ "place_page_main_row5" } src={place5}  alt="place5"/>
                        <img className={ "place_page_main_row5" } src={place6}  alt="place6"/>
                    </Box>
                    <Box className={ "place_page_main_row3" }>
                        <Box>
                    ...
                    <Box className={ "place_page_main_row4" }>
                        <img className={ "place_page_main_row5" } src={place9}  alt="place9"/>
                    </Box>
                    <Box className={ "place_page_main_row3" }>
                        <Box>
                    ...
                    <Box className={ "place_page_main_row4" }>
                        <img className={ "place_page_main_row5" } src={place7}  alt="place7"/>
                    </Box>
                    <Box className={ "place_page_main_row3" }>
                        <Box>
                    ...
                    <Box className={ "place_page_main_row4" }>
                        <img className={ "place_page_main_row5" } src={place8}  alt="place8"/>
                    </Box>
                </Box>
            </Box>
        </Box>
