...
function AdSearchTypeSelectBox(props) {
    const ad_search_type_select_change = () => {
        props.getAdSearchTypeData(document.getElementById("ad_search_modal_type_select_box").options[document.getElementById("ad_search_modal_type_select_box").selectedIndex].innerText);
    }
    ...
    return (
        <Box style={{ display: 'flex', alignItems: 'center' }} >
            ...
            <Box style={{ position: 'relative', height: '100%', borderRadius: '10px', border: '2px solid gray'}}>
                <select id="ad_search_modal_type_select_box" defaultValue="0" style={{ position: 'relative', width: '180px', height: '100%', background: 'transparent', border: '0 none', padding: '0 5px', zIndex: '3' }} onChange={(e)=>{ad_search_type_select_change()}}>
...
export default AdSearchTypeSelectBox;
